...
export function Clients() {
    ...
    const add = async (e) => {
        e.preventDefault();
        const {data, status} = await setData('contacts/clients/', newdata)
                ...
                {open && <div className="new-cont-overlay">
                    <div className="new-form">
                        ...
                        <div>
                            ...
                            <StyledInput placeholder="Contact person" id="cpn" type="text" name="contact_name" value={newdata?.contact_name} onChange={onChange} />
                            <StyledInput placeholder="Contact phone number" id="cpp" type="text" name="contact_phone" value={newdata?.contact_phone} onChange={onChange} />
